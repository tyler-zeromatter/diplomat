...
namespace capi {
    ...
    somelib::capi::DiplomatMyStringView MyString_return_slice_of_opaques(somelib::capi::DiplomatMyStringView i);
...
inline somelib::diplomat::span<const somelib::MyString*> somelib::MyString::return_slice_of_opaques(somelib::diplomat::span<const somelib::MyString*> i) {
    auto result = somelib::capi::MyString_return_slice_of_opaques({reinterpret_cast<const somelib::capi::MyString**>(i.data()), i.size()});
    return somelib::diplomat::span<const somelib::MyString*>(reinterpret_cast<const somelib::MyString**>(result.data), result.len);
}
