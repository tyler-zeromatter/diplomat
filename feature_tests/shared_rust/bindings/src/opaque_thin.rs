...
unsafe extern "C" {
    fn OpaqueThin_a<'anon_0>(this: &'anon_0 OpaqueThin) -> i32;

    fn OpaqueThin_b<'anon_0>(this: &'anon_0 OpaqueThin) -> f32;

    fn OpaqueThin_c<'anon_0>(this: &'anon_0 OpaqueThin, write_mut : &mut crate::DiplomatWrite) -> ();
