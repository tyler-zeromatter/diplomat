...
pub mod borrowing_option_struct;
pub use borrowing_option_struct::BorrowingOptionStruct;
...
pub mod renamed_deprecated_opaque;
pub use renamed_deprecated_opaque::RenamedDeprecatedOpaque;
