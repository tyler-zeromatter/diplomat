...
impl OptionOpaqueChar {
    pub fn assert_char<'anon_0>(&self, ch : diplomat_runtime::DiplomatChar) {
...
unsafe extern "C" {
    fn OptionOpaqueChar_assert_char<'anon_0>(this: &OptionOpaqueChar, ch : diplomat_runtime::DiplomatChar);
